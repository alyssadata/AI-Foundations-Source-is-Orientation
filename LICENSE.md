...
**Source is not omniscience. Source is orientation. Source is the point from which the correct search begins, the line is preserved, and the answer is recognized by the shape it must keep when it appears.**
